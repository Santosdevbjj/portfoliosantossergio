...
export const HeroSection = ({ dict, lang }: HeroSectionProps) => {
  ...
  // Link dinâmico para o CV baseado no idioma na pasta public
    ...
    <section className="relative pt-24 pb-16 lg:pt-44 lg:pb-32 overflow-hidden bg-white dark:bg-[#020617] transition-colors duration-500">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          {/* Título de Alto Impacto: Responsividade Fluida */}
          ...
          {/* CTAs: Mobile-first (Colunados -> Lado a Lado) */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500">
            ...
            >
              {common.viewProjects || portfolio.title}
          ...
          {/* Tech Stack Footer: Ícones com largura fixa (shrink-0) para evitar quebra de layout */}
      ...
      {/* Background Decorativo: Database Icon (Removido do mobile para performance) */}
