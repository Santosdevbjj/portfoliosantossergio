...
/**
 * HERO SECTION: Impacto Inicial e Proposta de Valor
 * -----------------------------------------------------------------------------
 * - UI: Tipografia bold (13vw) e grid decorativo.
 * - I18n: Integrado com dict.hero, dict.contact e dict.projects.categories.
 * - Fix: Removido import redundante de React e tipagem de locale refinada.
 */
...
export function HeroSection({ dict, lang }: HeroSectionProps) {
  ...
  return (
    ...
    >
      {/* BACKGROUND DECORATIVO: Grid e Glow */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-4xl">
          ...
          {/* NOME COM IMPACTO VISUAL */}
          <h1 
            id="hero-title" 
            className="mb-8 text-[13vw] font-black leading-[0.85] tracking-tighter text-slate-900 dark:text-white sm:text-7xl md:text-8xl lg:text-[10rem]"
          >
            Sérgio <br className="hidden sm:block" />
            <span className="text-blue-600 inline-block">Santos</span>
          </h1>

          {/* HEADLINE E SUBTITLE (Multilingue) */}
          ...
          {/* CTAs: PROJETOS E CURRÍCULO */}
          <div className="flex flex-col gap-5 sm:flex-row">
            <a 
              href="#projects" 
              className="group flex min-w-[220px] items-center justify-center gap-3 rounded-2xl bg-blue-600 px-8 py-5 text-lg font-black text-white transition-all hover:bg-blue-700 shadow-xl shadow-blue-500/20 active:scale-95"
            >
              {hero.ctaPrimary}
            ...
            <a 
              ...
              className="flex min-w-[220px] items-center justify-center gap-3 rounded-2xl border-2 border-slate-200 bg-white px-8 py-5 text-lg font-bold text-slate-900 dark:bg-slate-900 dark:text-white dark:border-slate-800 transition-all hover:border-blue-600/50 hover:shadow-lg active:scale-95"
              aria-label={contact.cvLabel}
            >
          ...
          {/* QUICK STACK: Categorias sincronizadas com Dictionary */}
