 ...
 * Integra:
 * - navigation.ts (mini sitemap)
 * - LanguageSwitcher compartilhado
 * - CTA estratégico para perfis sênior
 */
export function Footer({ lang, dict }: FooterProps) {
  ...
  return (
    <footer className="bg-slate-50 dark:bg-[#020617] border-t border-slate-200 dark:border-slate-800/60 transition-colors mt-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-24 space-y-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
          ...
          {/* MINI SITEMAP */}
          <div>
            <h4 className={footerTitle}>{footer.sitemapTitle}</h4>
          ...
          {/* IDIOMA (LanguageSwitcher compartilhado) */}
          <div>
            <h4 className={footerTitle}>{footer.languageTitle}</h4>
            <LanguageSwitcher variant="footer" />
          </div>

          {/* CONTATO */}
          <div>
            <h4 className={footerTitle}>{footer.emailLabel}</h4>
