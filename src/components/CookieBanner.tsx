...
/**
 * COOKIE BANNER - LGPD/GDPR 2026
 * Responsivo, multilíngue (PT/EN/ES) e otimizado para UX.
 */
          ...
          <div className="flex-1 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button 
                ...
                aria-label={lang === 'pt' ? 'Fechar banner' : lang === 'es' ? 'Cerrar banner' : 'Close banner'}
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              <button 
                className="w-full sm:flex-1 text-[10px] font-black uppercase tracking-[0.15em] text-slate-500 dark:text-slate-400 underline underline-offset-8 hover:text-blue-600 transition-colors py-2 touch-manipulation"
                aria-label={currentContent.policy}
              >
