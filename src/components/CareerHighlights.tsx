 ...
 * Totalmente responsivo, tipado e multilingue (PT / EN / ES)
 */
export const CareerHighlights = ({ dict }: CareerHighlightsProps) => {
  ...
  const icons = [
    <Clock key="clock" className="w-6 h-6" aria-hidden />,
    <Server key="server" className="w-6 h-6" aria-hidden />,
    <ShieldCheck key="shield" className="w-6 h-6" aria-hidden />,
  ];
