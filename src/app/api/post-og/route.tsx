        ...
        >
          <div
            style={{
              ...
              flexDirection: 'column',
              padding: '40px 60px',
              backgroundImage: 'linear-gradient(to bottom, rgba(2,6,23,0) 0%, rgba(2,6,23,0.92) 70%)',
            }}
          >
            {/* Reading Time Badge - CORRIGIDO: display alterado de inline-flex para flex */}
            <div
              style={{
                display: 'flex',
            ...
            <div style={{ display: 'flex', fontSize: 54, fontWeight: 700, color: '#fff', lineHeight: 1.1, maxWidth: 900, marginBottom: 20 }}>
              {title}
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(255,69,0,0.3)', paddingTop: 25 }}>
              <div style={{ display: 'flex', alignItems: 'center', fontSize: 20, color: '#fff', fontWeight: 600 }}>
                <div style={{ width: 48, height: 48, borderRadius: 12, backgroundColor: '#ff4500', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, marginRight: 16 }}>
