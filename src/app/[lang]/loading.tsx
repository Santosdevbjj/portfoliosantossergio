 ...
 * - CLS Zero: Dimensões idênticas às seções reais (Hero e Cards).
 * - Acessível: Gerencia foco e estados aria para leitores de tela.
 * - Multilingue: Detecta idioma via atributo da tag HTML.
 */
...
export default function Loading() {
  ...
  useEffect(() => {
    const lang = document.documentElement.lang as keyof typeof LOADING_COPY;
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 pt-16 pb-20">
        ...
        >
          {[1, 2, 3].map((i) => (
            ...
            >
              {/* Shimmer Effect (Brilho que passa pelo card) */}
