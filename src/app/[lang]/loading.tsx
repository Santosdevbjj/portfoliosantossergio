 ...
 * Skeleton Screens neutros para evitar CLS e manter acessibilidade.
 * Nota: certifique-se de ter a animação 'shimmer' no tailwind.config.js:
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-8 pt-16 pb-20">
        ...
        {/* Skeleton HeroSection */}
        <div className="space-y-8 mb-24 animate-in fade-in duration-700" aria-hidden="true">
