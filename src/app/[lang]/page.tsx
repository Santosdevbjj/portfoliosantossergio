      ...
      <header className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center lg:text-left">
        ...
        <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
          ...
          <div className="flex gap-2">
            <a href="https://linkedin.com/in/seulink" target="_blank" className="p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 hover:text-blue-600 transition-colors shadow-sm">
              <Linkedin size={24} />
            </a>
            <a href="mailto:sergiosantosluiz@example.com" className="p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 hover:text-blue-600 transition-colors shadow-sm">
              <Mail size={24} />
            </a>
          </div>
        </div>
