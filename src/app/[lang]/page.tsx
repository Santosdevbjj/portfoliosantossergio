'use client' // Importante para garantir a reatividade do tema e layout
...
// Força a Vercel a sempre buscar dados novos e ignorar o cache antigo
...
export default async function Page(props: { params: Promise<{ lang: string }> }) {
  ...
  // 1. Ordem Rigorosa das Tecnologias
  const categoryOrder = [
  ...
  return (
    <div className="bg-[#f8fafc] dark:bg-[#0f172a] min-h-screen transition-colors duration-300">
      ...
      {/* HEADER - BIO PROFISSIONAL CORRIGIDO */}
      <header className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center lg:text-left">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-bold mb-8">
          <Shield size={18} /> {lang === 'pt' ? '15+ Anos em Sistemas de Missão Crítica' : '15+ Years in Mission-Critical Systems'}
        </div>
          ...
          <div className="relative z-10 flex flex-col xl:flex-row items-center gap-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full xl:w-1/2">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-yellow-500 font-bold text-sm tracking-widest text-center flex items-center gap-2 uppercase"><Award size={16}/> Vencedor 35ª Competição</p>
              </div>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-blue-400 font-bold text-sm tracking-widest text-center flex items-center gap-2 uppercase"><Medal size={16}/> Melhor Artigo do Mês</p>
              </div>
            </div>
